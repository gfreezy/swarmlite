...
use crate::{
    ...
    model::{
        ...
        DeploymentImageResolutionRecord, DeploymentListResponse, DesiredTaskState,
        GatewayAssignment, GatewayRecoverySnapshot, GatewayReport, GatewayStatus,
        HeartbeatResponse, ImageResolutionAssignment, ImageResolutionProgress,
        ...
        StackDeploymentCondition, StackDeploymentConditionKind, StackDeploymentError,
        StackDeploymentGatewayProgress, StackDeploymentImageProgress, StackDeploymentListResponse,
        StackDeploymentRecord, StackDeploymentResponse, StackDeploymentServiceProgress,
        StackDeploymentSnapshot, StackDeploymentStatus, StackDeploymentSummary,
